...
public class ClientHandler implements IoHandler {
	...
	public void messageReceived(IoSession arg0, Object arg1) throws Exception {
		...
		case GAME_START:
			...
			// and the name
			// of the locaplayer
			gc.createBoard(n.getLocale(), n.getUserNameList(),
		...
		case TURN_TOKEN:
			...
			// if the name is equal to the local player, enable buttons and set
			// current player
			if (n.getText().equals(localPlayerName)) {
				...
				if (username.equals(localPlayerName)) {
					...
					// function for setting the currentPlayer, turnToken and
